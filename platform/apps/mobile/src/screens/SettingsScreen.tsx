...
const styles = StyleSheet.create({
  ...
  option: { paddingHorizontal: 16, paddingVertical: 13, borderBottomWidth: StyleSheet.hairlineWidth }, optionHeader: { flexDirection: "row", alignItems: "center", gap: 11 }, optionLabel: { flex: 1, fontSize: 15 }, optionValue: { fontSize: 13 },
