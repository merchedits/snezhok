  ...
  return (
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <SafeAreaView style={[styles.screen, { backgroundColor: palette.background }]}> 
        <View style={[styles.header, { borderColor: palette.border }]}><Pressable onPress={onClose} style={styles.headerButton}><Text style={[styles.cancel, { color: palette.accent }]}>{t("cancel")}</Text></Pressable><Text style={[styles.title, { color: palette.text }]}>{t("newMessage")}</Text><View style={styles.headerButton} /></View>
