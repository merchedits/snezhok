...
export const messageBubbleStyles = StyleSheet.create({
  ...
  pendingAttachmentMask: { position: "absolute", top: 0, right: 0, bottom: 0, left: 0, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(20,22,28,0.24)" },
  attachmentProgressBadge: { width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(12,13,18,0.46)" },
  attachmentProgressText: { color: "white", fontSize: 10, lineHeight: 12, fontWeight: "900", fontVariant: ["tabular-nums"] },
  ...
  reaction: { borderWidth: 1, borderRadius: 12, minWidth: 27, height: 24, paddingHorizontal: 6, flexDirection: "row", gap: 3, alignItems: "center", justifyContent: "center" },
  overlayReaction: { backgroundColor: "rgba(17,18,24,0.58)", borderColor: "rgba(255,255,255,0.22)" },
  emoji: { fontSize: 13 },
  reactionCount: { fontSize: 10, fontWeight: "800", fontVariant: ["tabular-nums"] },
