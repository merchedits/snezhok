...
export async function userRoutes(fastify) {
    ...
    // Upload avatar
    fastify.post("/api/users/me/avatar", { preHandler: [requireAuth] }, async (request, reply) => {
        try {
    ...
    fastify.post("/api/users/invite", { preHandler: [requireAdmin] }, async (request, reply) => {
    ...
    fastify.get("/api/users/invites", { preHandler: [requireAdmin] }, async (request, reply) => {
        try {
